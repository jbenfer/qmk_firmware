 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |ctl(cap)| A      | S      | D      | F      | G      | -      | '      | =      | H      | J      | K      | L      | ;      | ENTER  |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | LSHIFT | Z      | X      | C      | V      | B      | [      | UP     | ]      | N      | M      | ,      | .      | /      | RSHIFT |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |LCTRL   | LGUI   | LALT   | LOWER  | SPACE  | SPACE  | LEFT   | DOWN   | RIGHT  | SPACE  | FN     | RAISE  | RALT   | RGUI   | RCTRL  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */

 [_QW] = { /* QWERTY */
  { KC_ESC,           KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_GRV,  KC_HOME, KC_PGUP, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC  },
  { KC_TAB,           KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_BSLS, KC_END,  KC_PGDN, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_DEL   },
  { CTL_T(KC_CAPS),   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_MINS, KC_QUOT, KC_EQL,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT   },
  { OSM(MOD_LSFT),    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, KC_UP,   KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, OSM(MOD_RSFT)  },
  { KC_LCTL,          KC_LGUI, KC_LALT, TT(_LW), KC_SPC,  KC_SPC,  KC_LEFT, KC_DOWN, KC_RGHT, KC_SPC,  TT(_FN), TT(_RS), KC_RALT, KC_RGUI, KC_RCTL  },
 },
